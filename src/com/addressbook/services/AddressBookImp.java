...
import com.addressbook.interfaces.IAAddressBook;
import com.addressbook.model.Contacts;

public class AddressBookImp implements IAAddressBook {
	...
	public void showContactsDetails(Contacts contacts) {
		...
		if (contacts != null) {
			...
			System.out.println("lastName = " + contacts.getLastNames());
